...
export function CustomizeColor({project, setBg, setText}: CustomizeColorProps) {
   ...
   return (
      <div className={`fixed left-2 sm:left-10 flex flex-col gap-4 items-center`}>
         ...
         <div className={`relative left-0 flex flex-col py-6 p-1 rounded-full items-center text-gray-800 font-semibold shadow-xl bg-orange-100 transition-all duration-500 ${open ? 'opacity-100' : 'opacity-0'}`}>
            <text>FUNDO</text>
